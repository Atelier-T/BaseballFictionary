...
<label for="posision">※「ポジション・役職」はメインを「1」に入れるようにして下さい。</label><br /><br />
    ...
    <label for="posision1">ポジション・役職2</label><br />
    ...
    <label for="posision1">ポジション・役職3</label><br />
    ...
    <label for="posision1">ポジション・役職4</label><br />
    ...
    <label for="posision1">ポジション・役職5</label><br />
